...
class Tags extends WP_REST_Controller {
    ...
    public function get_tags($request) {
        ...
        if ($request["event_id"]) {
            ...
            $query = "SELECT * FROM `{$this->prefix}tags` WHERE event_id = {$event_id}";
    ...
    public function delete_tags($request) {
        ...
        if ($parameters["ids"]) {
            ...
            $response = array("error" => "Es fehlen IDs, um Schlagwörter zu löschen.");
        }
    ...
    public function create_tag($request) {
        ...
        if ($parameters["name"] && $parameters["event_id"]) {
            ...
            if ($wpdb->last_error) {
                ...
                $response = array("success" => "Neues Schlagwort gespeichert!", "result" => $result);
            }
        } else {
    ...
    public function update_tag($request) {
        ...
        if ($parameters["name"]) {
            ...
            if ($wpdb->last_error) {
                ...
                $response = array("success" => "Aktualisiertes Schlagwort gespeichert!", "result" => $result);
            }
        } else {
